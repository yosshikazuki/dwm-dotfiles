...
static const char *fonts[]          = { "Noto Sans JP:size=18" };
static const char dmenufont[]       = "Noto Sans JP:size=18";
...
static const char *colors[][3]      = {
	...
	[SchemeInfoSel]  = { col_gray4, col_gray1 /*col_cyan*/,  "#000000"  },
...
static const char hpitems[] = { "firefox,burpsuite,obsidian,code,postman,Chromium,dolphin" };
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-hp", hpitems, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *surfcmd[] = { "dmenu_websearch", NULL };
...
//	{ MODKEY|ShiftMask,             XK_0,      tag,            {.ui = ~0 } },
	...
	{ MODKEY|ControlMask,		XK_k,      volumeup,       {0} },
	{ MODKEY|ControlMask,           XK_j,      volumedown,     {0} },
