...
static const char *colors[][3]      = {
	...
	[SchemeInfoSel]  = { col_gray4, col_gray2 /*col_cyan*/,  "#000000"  },
	[SchemeInfoNorm]  = { col_gray4, col_gray2,  "#000000"  },
};
...
static const char hpitems[] = { "firefox,burpsuite,obsidian,code,postman,Chromium,vesktop,thunar" };
